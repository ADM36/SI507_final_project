...
Duncan = CommonPlayerInfo("203076")
duncan_data = Duncan.common_player_info.get_data_frame()

print(duncan_data.columns)
#print(duncan_data['FIRST_NAME'])
#print(duncan_data['LAST_NAME'])
#print(duncan_data['SCHOOL'])
print(duncan_data.at[0,'SCHOOL'])
print(duncan_data.at[0,'HEIGHT'])
print(duncan_data.at[0,'WEIGHT'])
